 ...
 * img路径：{test:/\.(png|jpg)/,loader:'file',query:{name:'/images/[name].[ext]?[sha512:hash:base64:7]'}} 绝对路径
 * 
 * 关于同步加载和异步加载
...
module.exports = {
    ...
    entry:[
        'webpack-dev-server/client?http://127.0.0.1:2016',
